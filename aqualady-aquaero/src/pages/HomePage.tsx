...
export default function HomePage() {
  ...
  const DAY_SHORT = ['pon', 'wt', 'sr', 'czw', 'pt', 'sob', 'niedz']
  return (
    <div className="space-y-0 pb-8">
      {/* HERO SECTION */}
      <div className="-mx-4 sm:-mx-6 lg:-mx-8">
        <section className="relative w-full overflow-hidden min-h-[520px] sm:min-h-[50vh] lg:min-h-[calc(65vh+80px)]">
          <img
            src={heroImage}
            alt=""
          ...
          <div className="relative z-10 flex flex-col justify-between px-5 sm:px-8 lg:px-12 xl:px-16 pt-4 sm:pt-8 lg:pt-10 min-h-[520px] sm:min-h-[50vh] lg:min-h-[calc(65vh+80px)]">
            {/* WhatsApp Buttons — ������� слева */}
            <div className="flex flex-col gap-3 sm:gap-4 self-start">
              <a
                href="#"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 sm:gap-4 px-5 sm:px-6 py-4 sm:py-5 rounded-2xl bg-gradient-primary text-white hover:brightness-110 active:scale-[0.98] transition-all shadow-lg shadow-black/10 group"
              >
                <svg className="w-10 h-10 sm:w-10 sm:h-10 shrink-0 text-white" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="flex flex-col text-left flex-1">
                  <span className="text-xl sm:text-xl font-bold leading-tight">Grupa informacyjna</span>
                  <span className="text-xl sm:text-xl text-white/70 leading-tight">Sprawdz szczegoly</span>
                </div>
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 sm:gap-4 px-5 sm:px-6 py-4 sm:py-5 rounded-2xl bg-gradient-secondary text-white hover:brightness-110 active:scale-[0.98] transition-all shadow-lg shadow-black/10 group"
              >
              <svg className="w-10 h-10 sm:w-10 sm:h-10 shrink-0 text-white" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
              </svg>
              <div className="flex flex-col text-left flex-1">
                <span className="text-xl sm:text-xl font-bold leading-tight">Masz pytania?</span>
                <span className="text-xl sm:text-xl text-white/80 leading-tight">Napisz do nas</span>
              </div>
              <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white/60 group-hover:translate-x-1 transition-transform shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 5l7 7-7 7" />
              </svg>
            ...
            <div className="max-w-3xl mb-10 sm:mb-14">
                ...
                >
                  <span className="text-4xl">Studio aqua aerobiku</span><span className="text-4xl">"Aqua Lady"</span>
                </span>
                <span
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2">
            {[
              ...
              <div key={i} className="flex items-center gap-2 text-lg sm:text-xl text-stone-600">
                <svg className="w-6 h-6 sm:w-7 sm:h-5 shrink-0 text-gradient-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
