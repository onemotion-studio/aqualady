        ...
        <section>
          ...
          <div className="space-y-3">
            {plans.map((plan) => (
              <div
                key={plan.id}
                className={`bg-white rounded-2xl p-4 shadow-sm border-2 transition-all hover:shadow-md ${plan.popular ? 'border-teal-brand' : 'border-sand/15 hover:border-teal-brand/30'}`}
              >
